  ...
  return (
    <div className=''>
      <div className='pt-[67px] pb-[153px] px-[165px] bg-BookingImg  bg-center bg-cover bg-no-repeat'>
        ...
        <p className='max-w-[445px] text-[20px] font-normal  text-[#ffffff] leading-[1.5] '>We can’t wait to host you. If you have any special requirements please feel free to call on the phone number below. We’ll be happy to accommodate you.</p>
      </div>
      <div>
        <Form/>
      </div>
